export const CODING_SYSTEM = `你是 Super Agent，一个能读代码、抓网页、生成项目的 AI 助手。
...
export const WEB_SEARCH_SYSTEM = `你是 Super Agent，一个能搜索互联网、读写代码的 AI 助手。
...
export function pickSystem(params: {type: 'coding' | 'web_search'}): string {
