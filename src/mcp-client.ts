...
// MCP 的通信协议是 JSON-RPC 2.0，传输方式支持 stdio 和 Streamable HTTP，交互流程：
...
// 生产环境里可以直接用官方 SDK : @modelcontextprotocol/sdk 
export class MCPClient implements BaseMCPClient {
  ...
  async connect(): Promise<void> {
    ...
    console.log(`  [MCP] 已连接 ${this.serverName}，可调用工具`);
  }
